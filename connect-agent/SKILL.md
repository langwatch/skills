...
- The simulations page URL of their LangWatch project (`https://app.langwatch.ai/<project-slug>/simulations`, or the same path on their own instance when self-hosted).
